<h1 align="center"> Trilha JS Developer - Projeto Pokédex</h1>
...
Você pode visualizar o layout do projeto através [DESSE LINK](https://dribbble.com/shots/6540871-Pokedex-App). É necessário ter conta no [Dribbble](https://dribbble.com/) para acessá-lo.
